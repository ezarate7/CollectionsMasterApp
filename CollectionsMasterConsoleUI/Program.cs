    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            while (!int.TryParse(userResponse, out userInput))
            {
                Console.WriteLine($"{userResponse} could not be parsed. Please enter an integer.");
            ...
            var convertedToArray = myList.ToArray();
